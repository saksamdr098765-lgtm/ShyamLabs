...
// export const packages = packagesData.map((pkg) => ({
//   ...pkg,
//   name: pkg.name || pkg.title,
//   slug: pkg.slug || pkg.id,
//   priceCard: pkg.priceCard || {
//     actualPrice: pkg.originalPrice || pkg.price + 300,
//     offerPrice: pkg.price,
//     offerText: pkg.discount || "Special Offer",
//     reportTime: pkg.reportTime || "24-48 Hours",
//     fasting: pkg.fasting || "10-12 Hours",
//     sampleType: "Blood",
//     homeCollection: true,
//   },
// }));
